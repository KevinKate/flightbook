...
<main id="main">
	<div class="container">
		<div class="col-lg-12">
			...
			<div class="row">
				<div class="col-md-12">
					<button class="float-right btn btn-dark btn-sm" type="button" id="new_location">Add New <i class="fa fa-plus"></i></button>
				</div>
			</div>
		<?php endif; ?>
			<div class="row">
							...
							if(Object.keys(resp).length > 0){
								...
								Object.keys(resp).map(k=>{
									...
									if('<?php echo isset($_SESSION['login_id']) ? 1 : 0 ?>' == 1){
										tr.append('<td><center><button class="btn btn-sm btn-primary edit_location mr-2" data-id="'+resp[k].id+'"><i class="fa fa-edit"></i></button><button class="btn btn-sm btn-danger remove_location" data-id="'+resp[k].id+'"><i class="fa fa-trash"></i></button></center></td>')
									}else{
