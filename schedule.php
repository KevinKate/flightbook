...
<main id="main">
	<div class="container-fluid">
		<div class="col-lg-12">
			...
			<div class="row">
				<div class="col-md-12">
					<button class="float-right btn btn-dark btn-sm" type="button" id="new_schedule">Add New <i class="fa fa-plus"></i></button>
				</div>
			</div>
		<?php endif; ?>
			<div class="row">
						...
						resp = JSON.parse(resp)
							if(Object.keys(resp).length > 0){
								...
								Object.keys(resp).map(k=>{
									...
									tr.append('<td class="">'+resp[k].flight+'</td>')
									...
									tr.append('<td><center><button title="EDIT" class="btn-sm btn-primary edit_schedule mr-2" data-id="'+resp[k].id+'"><i class="fa fa-edit"></i></button><button title="DELETE" class="btn btn-sm btn-danger remove_schedule" data-id="'+resp[k].id+'"><i class="fa fa-trash"></i></button></center></td>')
									}else{
										tr.append('<td><center><button class="button1 mr-2  text-white book_now" data-id="'+resp[k].id+'"><strong class="button1_top">Book</strong></button></center></td>')
									}
