...
<html>
	<head>
        ...
        // }
        ?>
		<title>Admin Login |Flight Booking</title>
	</head>
    <style>
        body {
	...
	<body id='login-body' class="bg-light">
    		<div class="card col-md-4 offset-md-4 mt-4  glass">
            ...
            <div class="card-body ">
                     <form id="login-frm">
                        <div class="form-group">
                            ...
                            <input type="username" name="username" class="form-control glass">
                        </div>
                        <div class="form-group">
                            <label>Password</label>
                            <input type="password" name="password" class="form-control glass">
                        </div> 
